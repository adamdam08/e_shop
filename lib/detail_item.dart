              ...
              child: Stack(
                children: [
                  NotificationListener<ScrollUpdateNotification>(
                    onNotification: (ScrollNotification scrollInfo) {
                      setState(() {
                        ...
                        // print("MASUK ${}");
                        print("MASUK ${scrollInfo.metrics.pixels / scrollInfo.metrics.maxScrollExtent}");
                        if(newAlpha > 0.0){
                          headerAlpha = 1;
                        }else{
                          headerAlpha = 0;
                  ...
                  AnimatedContainer(
                    ...
                    padding:  (headerAlpha > 0.0) ? const EdgeInsets.symmetric(horizontal: 10) :const EdgeInsets.symmetric(vertical: 10, horizontal: 20) ,
